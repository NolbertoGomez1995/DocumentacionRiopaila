...
"SEGURIDAD":{
  "PORTAL DEL COLABORADOR":["CREACION DEL CASO","CREACION DE USAURIO","CREACION DE USUARIO TERCERO O PRACTICANTE","USUARIO YA CREADO EN EL PORTAL","CAMBIO DE CONTRASEÑA"],
...
"PLANTILLAS DE TEAMS":{
  "SALUDOS":["SALUDO MAÑANA","SALUDO TARDE","DESPEDIDA","USUARIOS AFANADOS","NO APROBACION 5 DIAS"],
...
"SOLMAN": `<h3>SOLMAN</h3>
  ...
  "CASOS MAL MONTADOS": `<h3>CASOS MAL MONTADOS</h3>
                         ...
                         <p>Solución: Se identificó que la solicitud estaba mal creada y que existía una categoría específica para dicha solicitud. 
                         La ruta adecuada para crear el requerimiento es <strong>XXXXXXXXXXXXXXXXXXXXXXXXXX</strong>. Se recomienda generar la solicitud por la ruta indicada.</p>
                         <p>Se procederá a cerrar el caso por la incorrecta generación de la solicitud. Para asistencia, contactar al soporte.</p>`,
  
  "MANTENIMIENTO PREVENTIVO A EQUIPOS": `<h3>MANTENIMIENTO PREVENTIVO A EQUIPOS</h3>
                                         <h4>ASUNTO: Revisión de Computador Lento</h4>
                                         <p>Solución: Para generar el caso de revisión del computador lento, sigue estos pasos:</p>
                                         <ul>
                                             <li>Ingresa a la plataforma de Dulce a través de Intranet.</li>
                                             ...
                                             <li>Rellena el campo con la solicitud que requieres, indicando el problema del equipo y su ubicación.</li>
                                             <li>Si es posible, adjunta el número de Anydesk para la conexión.</li>
                                         </ul>`,
  ...
  "CÓMO CREAR CASO DE CAMBIO DE CONTRASEÑA": `<h3>SUCCESFACTOR</h3>
                                              ...
                                              <p>Solución: Para generar la solicitud de cambio de contraseña en la plataforma Succesfactor, sigue estos pasos:</p>
                                              <ol>
                                                  ...
                                                  <li>Llena la solicitud y en el campo necesidad selecciona <strong>SSFF NO SE TIENE LA CLARIDAD DE LA CONTRASEÑA SE OLVIDÓ PARA INGRESAR</strong>.</li>
                                                  <li>Envía la solicitud.</li>
                                              </ol>
                                              <p>Una vez validada y lista, se informará al usuario por correo automático y Teams.</p>`,
"INGRESO DE FICHA EN SUCCESFACTORS": `<h3>INGRESO DE FICHA EN SUCCESFACTORS</h3>
                                       <h4>ASUNTO: Verificación de Ficha</h4>
                                       <p>Solución: Se accede a la plataforma de Succesfactors y se verifica con el número de ficha del usuario. Se confirma que el usuario ingresa con la ficha y la contraseña Agosto2024.</p>`,
"COMO CREAR CASO DE NUEVO EMPLEADO": `<h3>CÓMO CREAR EL CASO DE NUEVO EMPLEADO</h3>
                                           ...
                                           <ol>
                                               ...
                                               <li>Navega a la categoría <strong>SELFSERVICE</strong>.</li>
                                               <li>Selecciona <strong>MARKETPLACE</strong> o <strong>MERCADO</strong>.</li>
                                               <li>Accede a <strong>PERSONAL</strong> y selecciona la opción INGRESO DE PERSONAL NUEVO USUARIO.</li>
                                               <li>Completa los campos requeridos en la solicitud. Si necesitas un usuario SAP,</li>
                                               <li>Envía la solicitud. Se generarán entre 4 y 5 solicitudes adicionales (dependiendo de si se requiere SAP o no), tales como:</li>
                                               <ul>
                                                   <li>Creación de usuario en portal de colaboradores.</li>
                                                   <li>Creación de cuenta de correo electrónico.</li>
                                                   <li>Creación de usuario en directorio activo.</li>
                                                   <li>Configuración de equipo de cómputo.</li>
                                               </ul>
                                               <li>Todas estas solicitudes requerirán la aprobación del jefe del área, y la solicitud de SAP requerirá una aprobación adicional del jefe de seguridad.</li>
                                               <li>Se podrá consultar el progreso mediante los correos que se enviarán automáticamente.</li>
                                           </ol>`,
    ...
    "CREACION DE USUARIO EN DIRECTORIO ACTIVO": `<h3>CREACIÓN DE USUARIO EN DIRECTORIO ACTIVO (DA)</h3>
                                                    ...
                                                    <p>Solución: Se ha completado la creación del usuario en el directorio activo para xxxxxxxxxxx en el marco del caso REQxxxxxxx. La información de ingreso es la siguiente:</p>
                                                    <ul>
                                                        <li>Usuario RED: xxxxxx</li>
    ...
    "CREACION CUENTA CORREO": `<h3>CREACIÓN DE CUENTA DE CORREO</h3>
                                     <h4>ASUNTO: Creación de Cuenta de Correo Electrónico</h4>
                                     ...
                                     <ul>
                                         <li>Correo Electrónico: XXXXXXXXXXXXXXXXXX</li>
                                     </ul>`,

    "CREACION USUARIO EN PORTAL DEL COLABORADOR": `<h3>CREACIÓN DE USUARIO EN PORTAL COLABORADOR</h3>
                                                <h4>ASUNTO: Creación de Cuenta en Portal del Colaborador</h4>
                                                <p>Solución: Se ha completado la creación de la cuenta solicitada para el usuario xxxxxxxxxx en el marco del caso REQxxxxxxx. Los datos de ingreso proporcionados son los siguientes:</p>
                                                <ul>
                                                    <li>Portal del Colaborador: Ficha asignada</li>
                                                    <li>Contraseña: 1234</li>
                                                </ul>
                                                <p>Recuerda que las contraseñas asignadas son temporales y deben ser modificadas en el primer inicio de sesión. La contraseña debe contener al menos una letra mayúscula, números, caracteres especiales y una longitud mínima de 8 dígitos.</p>`,

"CREAR CASO PARA NUEVO USUARIO SAP": `<h3>CREAR CASO PARA NUEVO USUARIO SAP</h3>
<h4>ASUNTO: Creación de Usuario SAP</h4>
...
"CREACION DE USUARIO EN SAP": `<h3>CREACIÓN USUARIO SAP</h3>
<h4>ASUNTO: CREACIÓN USUARIO SAP</h4>
...
"SOLICITUD DE CARPETA COMPARTIDA": `<h3>SOLICITUD CARPETAS COMPARTIDAS</h3>
<h4>ASUNTO: Solicitar Acceso a Carpetas Compartidas</h4>
...
<p>Solución: Se asigna el aprobador correspondiente para la carpeta: XXXX del servidor XXXX. El caso se escala al área de Seguridad Informática para su revisión y autorización.</p>`,

"CONFIGURAR CARPETA EN EQUIPO": `<h3>CONFIGURAR CARPETA EN EQUIPO</h3>
<h4>ASUNTO: Configurar Carpeta en Equipo</h4>
...
"CARPETA CON COPIA SIN CONEXION": `<h3>CARPETA CON COPIA SIN CONEXIÓN</h3>
<h4>ASUNTO: Carpeta con Copia sin Conexión</h4>
...
"MODO SEGURO": `<h3>MODO SEGURO</h3>
<h4>ASUNTO: Modo Seguro</h4>
...
"VALIDAR LICENCIA": `<h3>VALIDAR LICENCIA</h3>
<h4>ASUNTO: Sin Licencia (E1/E3)</h4>
...
"COMO SOLICITAR LICENCIA": `<h3>COMO SOLICITAR LICENCIA</h3>
<h4>ASUNTO: Solicitar Licencia</h4>
...
"COMPLEMENTOS DE TEAMS": `<h3>COMPLEMENTOS DE TEAMS</h3>
<h4>ASUNTO: Complemento de Teams</h4>
...
"INSTALAR ARCHIVOS PST": `<h3>INSTALAR ARCHIVO PST</h3>
<h4>ASUNTO: Archivo .PST</h4>
...
"CORREOS EN LISTA BLANCA": `<h3>CORREOS EN LISTA BLANCA</h3>
<h4>ASUNTO: Correo en Lista Blanca - Usuario</h4>
...
"CERRAR CASO CORREO LISTA BLANCA": `<h3>CERRAR CASO CORREO LISTA BLANCA</h3>
<h4>ASUNTO: Validar Correo Lista Blanca - Caso</h4>
...
"CERRAR CASO LISTA BLANCA DOCUMENTACION": `<h3>CERRAR CASO LISTA BLANCA DOCUMENTACION</h3>
<h4>ASUNTO: Correo en Lista Blanca - Respuesta</h4>
<p>Solución: Se validó con el proveedor y se proporcionó la respuesta sobre la solicitud.</p>`,

"PERMISOS DE CORREO EN CELULAR": `<h3>PERMISOS CORREO EN CELULAR</h3>
<h4>ASUNTO: Permisos Outlook Correo Electrónico</h4>
...
"CREACION DE USUARIO EN DA": `<h3>CREACION DE USUARIO EN DA</h3>
<h4>ASUNTO: Creación Usuario en DA</h4>
...
"DESBLOQUEO DE USUARIO": `<h3>DESBLOQUEO USUARIO</h3>
<h4>ASUNTO: Desbloqueo</h4>
...
"CAMBIO DE CONTRASEÑA PRIMER ACCESO": `<h3>CAMBIO DE CONTRASEÑA PRIMER ACCESO</h3>
<h4>ASUNTO: Cambio de Contraseña Primer Acceso</h4>
...
"CAMBIO DE CONTRASEÑA REPISADA": `<h3>CAMBIO DE CONTRASEÑA REPISADA</h3>
<h4>ASUNTO: Cambio de Contraseña - Repisada</h4>
...
"CAMBIO DE CONTRASEÑA": `<h3>CAMBIO DE CONTRASEÑA</h3>
<h4>ASUNTO: Cambio de Contraseña por el Usuario</h4>
...
"HABILITAR CUENTA": `<h3>HABILITAR CUENTA</h3>
<h4>ASUNTO: Habilitar Cuenta</h4>
...
"HABILITAR CUENTA DE TERCERO": `<h3>HABILITAR CUENTA DA A TERCERO</h3>
<h4>ASUNTO: Habilitar Cuenta DA a Tercero Autorizado</h4>
...
"MODIFICACION DE USUARIO": `<h3>MODIFICACION DE USUARIO</h3>
<h4>ASUNTO: Modificación Usuario Documentación</h4>
<p>Solución: Se actualizan los datos del usuario en el directorio activo según la información proporcionada. Se valida que los datos han sido correctamente actualizados. Se procede al cierre del caso.</p>`,

"CREAR CASO DE MODIFICACION DE USUARIO": `<h3>CREAR CASO DE MODIFICACION DE USUARIO</h3>
<h4>ASUNTO: Modificación Usuario Crear Caso</h4>
...
"ELIMINACION DE EQUIPO DE DOMINIO": `<h3>ELIMINACION EQUIPO DEL DOMINIO</h3>
<h4>ASUNTO: Eliminación Equipo del Dominio</h4>
...
<ol>
    <li>Accede a la plataforma Dulce a través de la intranet.</li>
    <li>Navega a la sección de "SELFSERVICE" y selecciona "MARKETPLACE".</li>
    <li>Selecciona la opción “ESTACION DE TRABAJO”.</li>
    <li>Selecciona la opción “ALISTAMIENTO Y RETIRO DE PUESTO DE TRABAJO”.</li>
    <li>Selecciona en la opción Necesidad “ADQUISICION DE EQUIPO”.</li>
    <li>Llena la solicitud y procede a enviarla. El área encargada validará el inventario y se pondrá en contacto contigo.</li>
</ol>`,

"CONFIGURACION DE EQUIPO DE COMPUTO": `<h3>CONFIGURACION DE EQUIPO DE COMPUTO</h3>
<h4>ASUNTO: Configuración de Equipo de Cómputo</h4>
...
<ol>
    ...
    <li>Selecciona la opción “ESTACION DE TRABAJO”.</li>
    <li>Selecciona la opción “ALISTAMIENTO Y RETIRO DE PUESTO DE TRABAJO”.</li>
    <li>Selecciona en la opción Necesidad “CONFIGURACION DE EQUIPO”.</li>
    <li>Llena la solicitud y procede a enviarla. El área encargada validará y configurará el equipo.</li>
</ol>`,

"PRESTAMO DE EQUIPOS Y ACCESORIOS": `<h3>PRESTAMO DE EQUIPOS Y ACCESORIOS</h3>
<h4>ASUNTO: Préstamo de Equipos y Accesorios</h4>
...
"SOLICITUD DE PERIFERICOS": `<h3>SOLICITUD DE PERIFERICOS</h3>
<h4>ASUNTO: Solicitud de Periféricos</h4>
...
"FALLAS DE IMPRESION": `<h3>FALLAS DE IMPRESIÓN</h3>
<h4>ASUNTO: Reportar falla con impresoras o scanner</h4>
...
<ol>
    ...
    <li>Selecciona la solicitud “FALLAS DE IMPRESIÓN” y clic en solicitar.</li>
...
"FALLAS DE RED": `<h3>FALLAS DE RED</h3>
<h4>ASUNTO: Reportar falla con la red</h4>
<p>Solución: Para reportar la falla se debe de crear la solicitud en nuestra plataforma Dulce por la siguiente ruta:</p>
<ol>
    <li>Accede a la plataforma Dulce a través de la intranet.</li>
    <li>Navega a la sección de "SELFSERVICE" y selecciona "MARKETPLACE".</li>
    <li>Selecciona la categoría “INFRAESTRUCTURA”.</li>
    <li>Selecciona la solicitud “FALLAS DE RED” y clic en solicitar.</li>
    <li>Llena los datos de la solicitud y en necesidad selecciona la que más se adapte a tu falla, en el campo descripción breve introduce toda la información de tu problema. Si no encuentras la falla en necesidad, selecciona la que más se asemeje y especifica en el campo Descripción.</li>
...
"FALLAS CON EL PAQUETE OFFICE": `<h3>FALLAS CON EL PAQUETE OFFICE</h3>
<h4>ASUNTO: Reportar falla con aplicaciones Office</h4>
<p>Solución: Para reportar la falla se debe de crear la solicitud en nuestra plataforma Dulce por la siguiente ruta:</p>
<ol>
    <li>Accede a la plataforma Dulce a través de la intranet.</li>
    <li>Navega a la sección de "SELFSERVICE" y selecciona "MARKETPLACE".</li>
...
"CREACION DE SOLICITUDES": `<h2>CREACIÓN DE SOLICITUD INSTALACIÓN-ACTUALIZACIÓN SOFTWARE</h2>
...
"ACTUALIZACION DE SOFTWARE": `<h2>ACTUALIZACIÓN DE SOFTWARE</h2>
<h3>ASUNTO: ACTUALIZACIÓN DE SOFTWARE</h3>
...
"ACTUALIZACION DE WINDOWS": `<h2>ACTUALIZACIÓN DE WINDOWS</h2>
<h3>ASUNTO: ACTUALIZACIÓN DE WINDOWS</h3>
...
"ACTUALIZACION DE APLICACIONES": `<h2>ACTUALIZACIÓN APLICACIÓN</h2>
<h3>ASUNTO: ACTUALIZACIÓN APLICACIÓN-FIN TAREA</h3>
...
"INSTALACION DE APLICION": `<h2>INSTALACIÓN APLICACIÓN</h2>
<h3>ASUNTO: INSTALACIÓN</h3>
...
"EQUIPO LENTO": `<h2>EQUIPO LENTO</h2>
<h3>ASUNTO: EQUIPO LENTO</h3>
...
"CONFIGURAR EQUIPO DE DOMINIO": `<h2>CONFIGURAR EQUIPOS DEL DOMINIO</h2>
<h3>ASUNTO: CONFIGURAR EQUIPOS DEL DOMINIO</h3>
...
"COMO CREAR SOLICITUD DE PERMISOS": `<h2>CÓMO CREAR SOLICITUD DE PERMISOS</h2>
  ...
  <p><strong>SOLUCIÓN:</strong> Para crear la solicitud de crear, modificar o asignar roles o transacciones en SAP, debes hacer lo siguiente:
    <ol>
    ...
    La solicitud será atendida en orden de llegada y según disponibilidad, así que debes tener en cuenta el tiempo necesario. Una vez que tu requerimiento esté solucionado, la plataforma te enviará un mensaje al correo electrónico.</p>`,
...
"SALUDO MAÑANA": `<h2>MAÑANA</h2>
    ...
    <p>Hola, buenos días. Se comunicó con la Mesa de Ayuda. Mi nombre es Katherin Osorio. Cuénteme en qué le puedo colaborar el día de hoy, y con gusto le ayudaremos en unos minutos según la cantidad de solicitudes que se encuentren en gestión.</p>`,

"SALUDO TARDE": ` <h2>TARDE</h2>
    <p>Hola, buenos Tardes. Se comunicó con la Mesa de Ayuda. Mi nombre es Nolberto Gómez. Cuénteme en qué le puedo colaborar el día de hoy, y con gusto le ayudaremos en unos minutos según la cantidad de solicitudes que se encuentren en gestión.</p>
    <p>Hola, buenos Tardes. Se comunicó con la Mesa de Ayuda. Mi nombre es Katherin Osorio. Cuénteme en qué le puedo colaborar el día de hoy, y con gusto le ayudaremos en unos minutos según la cantidad de solicitudes que se encuentren en gestión.</p>`,
